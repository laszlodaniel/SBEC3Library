...
; MCU: 68HC16
; 
; Worker function to erase the N28F020 256k flash memory chip.
; 
; Command:
; 
; TX: 20
...
Try_P:
	...
	txkb				; B = XK
	cmpb	#8			; compare Bank to value, valid banks are 4, 5, 6 and 7 (256k)
